...
window.FF_CONFIG = {
  ...
  nav: [
    ...
    { divider: true },
    {
      id: "self",
      label: "자체컨텐츠",
      sel: { cats: ["sp_original", "sp_vlog", "sp_game", "sp_survive", "sp_beauty", "sp_corp", "sp_hayoung", "sp_jiwon", "sp_chaeng", "sp_ch9"] },
      children: ["sp_original", "sp_vlog", "sp_game", "sp_survive", "sp_beauty", "sp_corp", "sp_hayoung", "sp_jiwon", "sp_chaeng", "sp_ch9"],
      withAll: true,
    },
    { id: "workdol", label: "워크돌",      sel: { cat: "workdol" }, subBy: "year", withAll: true },
    { id: "plunen_idanjang", label: "이단장",      sel: { cat: "plunen_idanjang" }, subBy: "year", withAll: true },
    { id: "pulmuone_ei2", label: "이아이는요2",      sel: { cat: "pulmuone_ei2" }, subBy: "year", withAll: true },
    { id: "musinsa_seongsugi", label: "성수기",      sel: { cat: "musinsa_seongsugi" }, subBy: "year", withAll: true },
    { id: "bangpan", label: "방판소녀들",  sel: { cat: "bangpan" }, subBy: "year", withAll: true },
    { id: "kpan_ipdeok", label: "K판 입덕투어", sel: { cat: "kpan_ipdeok" }, subBy: "year", withAll: true },
