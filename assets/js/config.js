...
window.FF_CONFIG = {
  ...
  nav: [
    ...
    { id: "special", label: "스페셜무대",  sel: { cat: "special_stage" }, subBy: "year", withAll: true },
    {
      id: "self",
      label: "자체컨텐츠",
      sel: { cats: ["sp_original", "sp_vlog", "sp_game", "sp_survive", "sp_beauty", "sp_corp", "sp_hayoung", "sp_jiwon", "sp_chaeng"] },
      children: ["sp_original", "sp_vlog", "sp_game", "sp_survive", "sp_beauty", "sp_corp", "sp_hayoung", "sp_jiwon", "sp_chaeng"],
      withAll: true,
    },
